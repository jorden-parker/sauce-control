...
This decision is implemented. Live Docker verification passed, including stage separation, inspection/history/log protection and restart reinjection. Adapter tests cover both CLI variants; live Podman verification is pending because Podman is not installed in the verification environment.
